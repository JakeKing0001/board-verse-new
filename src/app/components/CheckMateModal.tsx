            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                <div className="text-center space-y-8 animate-fade-in z-10">
                    ...
                    <div className="relative">
                        ...
                        >
                            {isDraw ? (
                                <span className={clsx('font-bold', textColor)}>{t.drawText}</span>
                            ) : (
                                <>
                                    <span className={clsx('font-bold', textColor)}>{winnerColor}</span> {t.checkMateText}
                                </>
                            )}
                        </p>
                    </div>
                    ...
                    >  
                        <Link href={isChallenge ? document.referrer || '/' : '/'}>{isChallenge ? t.close : t.retry}</Link>
                    </button>
                </div>
            </div>
        </div>
