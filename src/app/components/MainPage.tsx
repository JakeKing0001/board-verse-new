    ...
    <>
      ...
      <div className={`fixed inset-0 flex items-center justify-center ${darkMode ? 'bg-slate-900' : 'bg-gradient-to-br from-green-100 via-amber-50 to-green-100'} pt-24 overflow-hidden`}>
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div className={`z-10 text-center p-14 ${darkMode ? 'bg-slate-800 text-white' : 'bg-white/40 text-green-800'} backdrop-blur-md rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 border ${darkMode ? 'border-slate-700' : 'border-white/50'}`}>
